...
PRODENV=( -e GGML_NVFP4_CUBLASLT=1 -e GGML_NVFP4_QUANT_TWOLEVEL=1 -e GGML_FP8_FFN=1 -e GGML_FP8_LAYERS=transformer_blocks -e LTX_DIT_F16=1
  ...
  -e LTX_VAE_HEAD_F32=1 -e LTX_VAE_CONV3D_WTILES=8 -e LTX_VAE_CONV3D_HTILES=4 -e LTX_VAE_DECODE_F16=1 )   # 22B-SAFE: HEAD_F32=striping fix; wtiles/decode_f16=VRAM; NO temporal_blend (unsafe on 22B 4-upsample)
