...
bool SDGenerationParams::from_json_str(
    ...
    // "sample_params" object below also sets these; these mirror the common knobs so a
    // flat request body works too. sample_method/scheduler are enums parsed by name.
